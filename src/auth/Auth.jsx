        ...
        <div className='authConatiner'>
            ...
            <div action="" className="form_main" >
                ...
                <div className="inputContainer">
                    ...
                    <input type="text" name='email' onChange={(e) => handleChange(e)} required className="inputField" id="username" placeholder="email" />
                </div>
                ...
                <div className="inputContainer">
                    ...
                    <input type="number" name='phone' onChange={(e) => handleChange(e)} required className="inputField" id="password" placeholder="phone" />
                </div>
